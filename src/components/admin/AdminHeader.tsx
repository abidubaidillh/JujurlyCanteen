        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-2.5 hover:bg-slate-100 rounded-xl px-2 py-1.5 transition-colors"
            >
              ...
              <HiChevronDown
                className={`text-slate-400 text-sm transition-transform duration-200 ${dropdownOpen ? "rotate-180" : ""}`}
              />
            </button>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl border border-slate-100 shadow-lg py-1 z-50">
                ...
                >
                  <HiPencilSquare className="text-base text-slate-400" />
                  Edit Profil
                </button>
              </div>
            )}
